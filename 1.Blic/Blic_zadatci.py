...
print (funkcija(['Stol', 'Stolica', 'Krevet', 'Fotelja']))    
print(funkcija2({"valute":["GBR", "USD", "CZK", "Error"], "cijena":[8.5, 7.7, 0.3, 10.3]}, {"valute":["EUR", "USD", "CZK", "Error"], 
"cijena":[7.5, 7.7, 0.3, 5.5]}))
print(funkcija3([{"naziv":"Burek", "kategorija":"pite", "ocjena":1}, {"naziv":"Ramsteak", "kategorija":"steak", "ocjena":9}, 
{"naziv": "Ribeye", "kategorija":"steak", "ocjena":4}, {"naziv":"Sirnica", "kategorija":"pite", "ocjena":5}]))
